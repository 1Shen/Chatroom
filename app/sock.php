...
class Sock
{
    ...
    * @$k client的socket对应的健，即每个用户有唯一$k并对应socket
    ...
    */
    ...
    //$sKey 发信息人的socketID $rKey接受人的 socketID ，根据这个socketID可以查找相应的client进行消息推送，即指定client进行发送
    function send1($sKey, $ar, $rKey = 'all')
    {
        ...
        if ($rKey == 'all') {
            ...
            if ($ar['type'] == 'add') {
                ...
                socket_write($users[$sKey]['socket'], $str1, strlen($str1));
