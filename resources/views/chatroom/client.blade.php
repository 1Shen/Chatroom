    ...
    <script>
        (function() {
                ...
                ws.onmessage = function(msg) {
                    ...
                    if (obj == false) {
                        ...
                        if (da.type == 'rmove') {
                            ...
                            var obj = A.$$('<p class="c2"><span>[' + da.time + ']</span>' + users[da.nrong]
                                .innerHTML + '退出聊天室</p>');
                            ...
                            if (da.code1 == mkey) {
                                ...
                                obj = A.$$('<p class="c3"><span>[' + da.time + ']</span><a>' + users[da.code]
                                    .innerHTML + '</a>对我说：' + da.nrong + '</p>');
                                ...
                                if (da.code1 != 'all')
                                    ...
                                    obj = A.$$('<p class="c3"><span>[' + da.time + ']</span>我对<a>' + users[da
                                        .code1].innerHTML + '</a>说：' + da.nrong + '</p>');

                                else

                                    obj = A.$$('<p><span>[' + da.time + ']</span>我对<a>' + users[da.code1]
                                        .innerHTML + '</a>说：' + da.nrong + '</p>');
                                ...
                                obj = A.$$('<p><span>[' + da.time + ']</span><a>' + users[da.code].innerHTML +
                                    '</a>对' + users[da.code1].innerHTML + '说：' + da.nrong + '</p>');
            ...
            A.$('sd').onclick = function() {
                ...
                ws.send('nr=' + esc(da) + '&key=' + key);

            }

            A.$('nrong').onkeydown = function(e) {

                console.log('nrong keydown');
                var e = e || event;
